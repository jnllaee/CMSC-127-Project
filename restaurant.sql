...
(1, 'april_may', 'April May', 'aprilmay123'),
(2, 'june_july', 'June July', 'junejuly123'),
(3, 'aug_sept', 'Aug Sept', 'augsept123');

INSERT INTO food_establishment (establishment_id, name, contact_info, average_rating, website, location) VALUES
(1, 'Burger Place', '0912-345-6789', 4, 'www.burgerplace.com', '123 That Burger Place'),
(2, 'Sushi Place', '0998-765-4321', 3, 'www.sushiplace.com', '456 Sushi Place Building'),
(3, 'Dumplings Place', '0956-789-1234', 5, 'www.dumplingsplace.com', '789 Dumplings St., Place');
...
(1, 1, '2023-01-06', 'yummy burger!', 3),
(2, 2, '2024-02-05', 'great sushi', 4),
(3, 3, '2023-03-04', 'the best xiaolongbao', 5),
(4, 1, '2022-04-03', 'best burger in town', 5),
(5, 2, '2024-05-02', 'delicious sushi', 3),
(6, 3, '2022-06-01', 'nice gyoza', 3);

INSERT INTO establishment_reviews (establishment_id, customer_id, date, content, rating) VALUES
(1, 1, '2022-01-04', 'best resto', 5),
(2, 2, '2023-02-05', 'great ambience', 4),
(3, 3, '2024-03-06', 'classy yet comfy', 5);
...
INSERT INTO food_reviews (item_id, customer_id, date, content, rating) VALUES
(7, 1, '2023-07-03', 'lacks ketchup', 3);
